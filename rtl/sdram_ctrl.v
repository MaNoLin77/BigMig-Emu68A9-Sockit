...
(
	...
	output     [15:0] cpuRD,
	output            ramready,
	// expose the write buffer's pending flag so the seam can complete a chip-RAM write on DRAIN rather than on buffer-accept
	output            write_busy
);
...
assign write_busy = write_req;   // VIA-B: high from capture until the RAS slot commits it

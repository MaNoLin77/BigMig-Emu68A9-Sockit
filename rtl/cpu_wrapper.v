...
module cpu_wrapper
(
	// no soft CPU here: what remains is the tie-offs plus autoconfig and address decode. The chip-bus master is the seam.
...
wire        longword;
	...
	// inert tie-offs: cpustate_p==1 means "no memaccess" so cpu_req stays low
	assign cpu_addr_p  = 32'd0;
	assign cpu_dout_p  = 16'd0;
	assign wr_p        = 1'b1;
	assign uds_p       = 1'b1;
	assign lds_p       = 1'b1;
	assign reset_out_p = 1'b1;
	assign longword    = 1'b0;
	assign cpustate_p  = 2'd1;
	assign cacr_p      = 4'd0;
	assign vbr_p       = 32'd0;
...
wire        reset_out_o;
	...
	assign reset_out_o = 1'b1;
	assign wr_o        = 1'b1;
	assign as_o        = 1'b1;
	assign lds_o       = 1'b1;
	assign uds_o       = 1'b1;
	assign fc_o        = 3'd0;
	assign cpu_dout_o  = 16'd0;
	assign cpu_addr_o  = 23'd0;
...
wire sel_autoconfig = (chip_addr[23:16] == 8'b11101000) && (ac_memcard); //$E80000 - $E8FFFF
